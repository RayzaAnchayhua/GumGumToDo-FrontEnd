...
const Todo = () => {
  return (
    <div className="bg-one-piece-color w-[75%] h-[15%] rounded-full shadow-lg justify-around flex flex-row items-center py-2">
      ...
      >
        <input
          ...
          className="bg-one-piece-color text-white rounded-md px-4 py-3 focus:outline-none
           focus:ring-white focus:ring-2 text-stroke-black w-full"
        />
      </div>
      <button
        className="border-none rounded-full bg-black w-32 h-14 text-white text-lg font-medium cursor-pointer"
      >
        ADD +
      </button>
